...
export default function TypingEffect() {
    ...
    const next = (e) => {
      e.preventDefault();
      router.push('/informations/info5')
    }
    return (
        <>
...
/>
                <Box className="box sb2">< Typewriter
                    onInit={(typewriter) => {
                        typewriter.typeString("Its an infrared observatory that will complement and extend the discoveries of the Hubble Space Telescope, with longer wavelength coverage and greatly improved sensitivity. ")
                            .callFunction(() => {
