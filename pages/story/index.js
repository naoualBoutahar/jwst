...
export default function TypingEffect() {
    ...
    const next = (e) => {
      e.preventDefault();
      router.push('/informations/info1')
    }
    return (
        <>
            ...
            <Box flexDirection="row"
                ...
                <Box className="box sb2">< Typewriter
                    onInit={(typewriter) => {
                        typewriter.typeString("Hello outsider , I'll be your guid through this journey , we will be discovering a lot of exciting destinations ")
                            .callFunction(() => {
